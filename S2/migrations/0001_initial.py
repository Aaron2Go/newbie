    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Holdings', models.IntegerField(null=True, verbose_name='持股数量')),
                ('Purchase_Price', models.FloatField(null=True, verbose_name='成本价')),
                ('Costs', models.FloatField(null=True, verbose_name='成本')),
                ('Cost_to_NAV', models.FloatField(null=True, verbose_name='成本占净值比例(%)')),
                ('Market_Price', models.FloatField(null=True, verbose_name='收盘价')),
                ('Market_Value', models.FloatField(null=True, verbose_name='市值')),
                ('Market_Value_to_NAV', models.FloatField(null=True, verbose_name='市值占净值比例(%)')),
                ('Valuation', models.FloatField(null=True, verbose_name='估值')),
                ('Status', models.CharField(max_length=10, null=True, verbose_name='交易状态')),
            ],
            options={
                'verbose_name': 'A股持仓',
